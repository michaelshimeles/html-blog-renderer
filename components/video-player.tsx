...
export const VideoPlayer: React.FC<CustomVideoPlayerProps> = ({ videoSrc }) => {
  ...
  return (
    <div ref={playerRef} className={!isMounted ? "flex flex-col justify-center items-center max-w-full relative h-[405px]" : "flex flex-col justify-center items-center max-w-full relative"}>
